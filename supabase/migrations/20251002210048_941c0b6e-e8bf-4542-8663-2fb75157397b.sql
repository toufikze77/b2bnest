-- Update the handle_new_user function to automatically enable 30-day free trial
...
DECLARE
  ...
  org_id UUID;
BEGIN
  -- Insert profile with default settings including display_name and FREE TRIAL
  ...
  IF user_count = 1 THEN
    ...
    VALUES (
      ...
      'You have been assigned as the owner of this platform with full administrative rights. Your 30-day free trial has started!',
      'welcome'
    );
  ELSE
    INSERT INTO public.user_roles (user_id, role)
    ...
    VALUES (
      NEW.id,
      'Welcome to BizzLink! 🎉',
      'Your 30-day free trial has started! Explore all premium features without any payment details required.',
      'welcome'
    );
  END IF;
