-- Security fix for payments table: Implement proper encryption and access control (Fixed)
...
-- Create secure function for payment creation (used by edge functions) - fixed parameter order
...
GRANT EXECUTE ON FUNCTION public.create_payment_record(text, text, integer, text, uuid, text, text, text, text, text, jsonb) TO authenticated;
