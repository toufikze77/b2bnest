...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    const emailHtml = `
      <div style="max-width: 600px; margin: 0 auto; padding: 20px; font-family: Arial, sans-serif;">
        ...
        <p style="font-size: 16px; line-height: 1.6; margin-bottom: 30px;">
          B2BNest is a comprehensive business management platform with project management, CRM, document generation, and AI-powered features to help your business grow.
        </p>
        <div style="text-align: center; margin: 30px 0;">
          <a href="${inviteUrl}" style="background-color: #2563eb; color: white; padding: 12px 30px; text-decoration: none; border-radius: 5px; font-weight: bold; display: inline-block;">
            Accept Invitation
          </a>
        </div>
    ...
    console.log("Invitation email sent successfully via Resend:", emailResponse);
