...
export default function AdminDashboard() {
  ...
  const cards = [
    ...
    { label: 'Active Companies', value: n('active_companies').toLocaleString(), icon: <Building2 className="h-4 w-4" /> },
    { label: 'Trial Companies', value: n('trial_companies').toLocaleString(), icon: <Gift className="h-4 w-4" /> },
    { label: 'Suspended Companies', value: n('suspended_companies').toLocaleString(), icon: <Building2 className="h-4 w-4" /> },
    { label: 'Cancelled Companies', value: n('cancelled_companies').toLocaleString(), icon: <Building2 className="h-4 w-4" /> },
    { label: 'New Companies (30d)', value: n('new_companies_30d').toLocaleString(), icon: <Building2 className="h-4 w-4" /> },
