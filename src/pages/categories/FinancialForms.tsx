...
import { Calculator, Upload, Plus, Lock } from 'lucide-react';
...
const FinancialForms = () => {
  ...
  const subcategories = ['Invoices', 'Receipts', 'Budgets', 'Reports', 'Tax Forms'];
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Financial Forms</h1>
              <p className="text-gray-600">Invoices, receipts, and financial documents</p>
            </div>
          </div>
          ...
          {!user && (
            <Alert className="mb-6">
              ...
              <AlertDescription>
                Please sign in to view and access financial documents.
              </AlertDescription>
            </Alert>
          )}
        ...
        {uploadMode && canUpload && (
          <Card className="mb-8">
            <CardHeader>
              ...
              <CardDescription>Add a new financial document template to the collection</CardDescription>
            </CardHeader>
            <CardContent>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <Input
                      ...
                      placeholder="finance, invoice, accounting, tax"
                    />
                  </div>
                  ...
                  <div className="mt-2 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md hover:border-purple-400 transition-colors">
                    <div className="space-y-1 text-center">
                      ...
                      <div className="flex text-sm text-gray-600">
                        <label htmlFor="file" className="relative cursor-pointer bg-white rounded-md font-medium text-purple-600 hover:text-purple-500">
