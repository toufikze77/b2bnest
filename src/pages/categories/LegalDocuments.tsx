...
import { Scale, Upload, Plus, Lock } from 'lucide-react';
...
const LegalDocuments = () => {
  ...
  const subcategories = ['Contracts', 'NDAs', 'Terms & Conditions', 'Privacy Policies', 'Employment'];
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Your legal document has been uploaded successfully."
      });
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-gray-600">Professional legal forms and templates</p>
            </div>
          </div>
          ...
          {!user && (
            <Alert className="mb-6">
              ...
              <AlertDescription>
                Please sign in to view and access legal documents.
              </AlertDescription>
            </Alert>
          )}
        ...
        {uploadMode && canUpload && (
          <Card className="mb-8">
            <CardHeader>
              ...
              <CardDescription>Add a new legal template to the collection</CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    placeholder="Describe the legal document and its use cases"
                    rows={3}
                  />
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <Input
                      ...
                      placeholder="contract, legal, agreement, business"
                    />
                  </div>
                ...
                <div>
                  ...
                  <div className="mt-2 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md hover:border-blue-400 transition-colors">
                    <div className="space-y-1 text-center">
                      ...
                      {formData.file && (
                        <p className="text-sm text-blue-600 font-medium">{formData.file.name}</p>
                      )}
                    </div>
                  </div>
                </div>
