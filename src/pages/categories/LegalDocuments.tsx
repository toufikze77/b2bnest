...
const LegalDocuments = () => {
  ...
  const subcategories = ['Contracts', 'NDAs', 'Terms of Service', 'Privacy Policies', 'Employment Law'];
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log('Submitting legal document:', formData);
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-gray-600">Contracts, agreements, and legal forms</p>
            </div>
          </div>
        ...
        {uploadMode && (
          <Card className="mb-8">
            <CardHeader>
              ...
              <CardDescription>Add a new legal document template to the collection</CardDescription>
            </CardHeader>
            <CardContent>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <Input
                      ...
                      placeholder="legal, contract, business, NDA"
                    />
                  </div>
