    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
        <div className="pt-20 pb-16">
          ...
          {/* Strategic Partners & Integrations Section */}
          <div className="py-16 px-4">
            <div className="container mx-auto max-w-6xl">
              ...
              <p className="text-center text-muted-foreground mb-8 max-w-2xl mx-auto">
                B2BNEST is planning to integrate with and be listed on major platforms to ensure maximum accessibility and liquidity for our community.
              </p>
              <div className="grid grid-cols-2 md:grid-cols-5 gap-6">
                {[
                  ...
                  <div
                    key={partner}
                    className="group relative p-6 rounded-xl bg-background/50 backdrop-blur-sm border-2 border-border hover:border-cyan-500/60 transition-all duration-300 hover:scale-105 hover:shadow-lg flex items-center justify-center"
                  >
                    <div className="absolute inset-0 bg-gradient-to-r from-cyan-400 to-blue-500 opacity-0 group-hover:opacity-5 rounded-xl transition-opacity duration-300" />
                    <p className="text-foreground font-semibold text-center relative z-10">{partner}</p>
                  </div>
                ))}
              </div>
            </div>
